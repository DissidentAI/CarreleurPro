...
Pose de carrelage, faïence, mosaïque, ragréage, douche à l’italienne, fournitures, TVA, devis transformé en facture, suivi des paiements, impayés, PDF propre à envoyer au client : tout est déjà là.

## Ce que ça fait

- Créer un devis complet en quelques minutes
- Transformer un devis accepté en facture
- Suivre les paiements et les restes à encaisser
- Générer des PDF propres et professionnels
- Envoyer devis et factures par email avec pièce jointe
- Importer d’anciens PDF avec OCR
- Suivre le chiffre d’affaires, les impayés et les meilleurs clients
- Sauvegarder automatiquement toutes les données en local
- Fonctionner hors ligne, sans compte, sans abonnement
